...
2. **Screen 02**: Login with password option ✅ NEW
...
(See SETUP.md for backend examples)
...
If you are using Expo Go on a physical phone, set the backend URL to your computer's LAN address:

```powershell
$env:EXPO_PUBLIC_FRAPPE_URL="http://192.168.1.6:8000"
npx expo start --tunnel
```

`localhost` will not work from a phone because it points to the phone itself, not your computer.
