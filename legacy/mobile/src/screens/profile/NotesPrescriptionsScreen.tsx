...
export const NotesPrescriptionsScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <Typography variant="h2" color={colors.ink}>Notes & Prescriptions</Typography>
      </View>
      <View style={styles.container}>
        <Ionicons name="document-text-outline" size={64} color={colors.inkFaint} style={styles.icon} />
        <Typography variant="body" color={colors.inkSoft} style={{ textAlign: 'center' }}>
          You don't have any notes or prescriptions yet.
        </Typography>
      </View>
    </SafeAreaView>
  );
