...
export const PastConsultationsScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <Typography variant="h2" color={colors.ink}>Past Consultations</Typography>
      </View>
      <View style={styles.container}>
        <Ionicons name="time-outline" size={64} color={colors.inkFaint} style={styles.icon} />
